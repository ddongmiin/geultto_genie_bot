...
user_pd = bigquery_client.run_query_to_dataframe(
    ...
    WHERE message_type = 'post'
        AND channel_id = 'C066SQT5MBK'
        AND tddate >= '2024-02-05' 
        AND tddate <= '2024-02-18'
...
{slack_message}
"""
slack_app.message_for_channel(channel_id="C066AQH75EZ", text=text)
